...
const Footer = () => {
    return (
        <div className=' dark:bg-[#292929] pt-16'>
            <section className='space-y-10 '>
                ...
                <div className='text-center space-y-4 dark:text-white '>
                    <div className='w-full border-b border-gray-200 dark:border-[#494949]'></div>
                    ...
                    <Fade triggerOnce>
                        <div className='flex items-center gap-2.5 justify-center'  >
                            ...
                            <a className="text-4xl font-bold text-[#e92d28] pb-1">RannaGhor</a>
                        </div>
                    </Fade>
                </div>
